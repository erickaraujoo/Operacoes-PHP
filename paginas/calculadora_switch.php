        ...
        if($valor1 != "" && $valor2 != ""){
            ...
            if(is_numeric($valor1) && is_numeric($valor2)){
                ...
                if(isset($_POST['radioGroup_calc'])){
                    ...
                    $result = calcularResultSwitch($valor1, $valor2, $vradio);
                ...
                <div class="sectionOperacao">
                    ...
                    <div class="container_calc">
                        ...
                        <div class="container_form">
                            ...
                            <form name="frmCalculadora_calc" method="post" action="calculadora_switch.php">
                                ...
                                <div class="container_valores">
                                    ...
                                    <div class="valores_calc">
                                        ...
                                        <div class="sectionBtnCalc">
                                            ...
                                            <input type="submit" name="btnResetar" value="Resetar" class="btnReset_calc">
                                        </div>
                                    </div>
                                </div>
